...
- Keep the Python backend as the only implementation for admin auth, knowledge management, SSE chat streaming, WebSocket updates, widget assets, and public config.
...
- Unchanged systems: Python FastAPI APIs, widget SDK contract, backend SSE/WebSocket endpoints, RAG/indexing services
